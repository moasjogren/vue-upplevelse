    ...
    <div class="card-top">
      ...
      <div class="card-difficulty">
        <img
          ...
          :key="index"
          :src="number <= (cardProps.difficulty || 0) ? star : starEmpty"
          alt=""
        />
      </div>
      <div class="card-info">
        ...
        <p>
          ...
          {{ cardProps.duration }} min
        </p>
      </div>
    </div>
    <div class="card-bottom">
      <h3 class="card-title">{{ cardProps.title }}</h3>
